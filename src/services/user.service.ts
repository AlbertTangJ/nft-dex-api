  ...
  async fetchUserSocialProfile(userAddress: string) {
    ...
    FROM (
        ...
        FROM (SELECT "userAddress", 
                CASE 
                  WHEN "ammAddress" = '0xfdee694ab487321a205ff077c757692ea172aafc' THEN COUNT("ammAddress") ELSE 0 END AS wcryptopunks_total,
                CASE
                  WHEN "ammAddress" = '0x1812dbda7a954e829a6ada968cee0d3f315ddba2' THEN COUNT("ammAddress") ELSE 0 END AS bayc_total,
                CASE	
                  WHEN "ammAddress" = '0x77eb2f64a0a94b98283060d35645e6e2eade029c' THEN COUNT("ammAddress") ELSE 0 END AS azuki_total,
                CASE
                  WHEN "ammAddress" = '0xf7749f92627985afde9bc8577a66cadc3e055589' THEN COUNT("ammAddress") ELSE 0 END AS mayc_total,
                CASE
                  WHEN "ammAddress" = '0x6aad9d74c2a9c0a185fc08adee633ab6a6968375' THEN COUNT("ammAddress") ELSE 0 END AS degods_total,
                CASE
                  WHEN "ammAddress" = '0x0c237df9af7c2246001c30e632839efb7c58a2f4' THEN COUNT("ammAddress") ELSE 0 END AS thecaptiainz_total,
                CASE
                  WHEN "ammAddress" = '0x99cdbb85154be3a2eb1876aead11d78cd9c17034' THEN COUNT("ammAddress") ELSE 0 END AS pudgypenguins_total,
                CASE
                  WHEN "ammAddress" = '0x98347f01b6b023bfbeb4b534cc48d43f2cfb562b' THEN COUNT("ammAddress") ELSE 0 END AS milady_total
                FROM "Position"
        ...
        SELECT  g."userAddress" 		  AS "userAddress",
          ...
          FROM (
              SELECT "userAddress" AS "userAddress",
                CASE 
                  WHEN "ammAddress" = '0xfdee694ab487321a205ff077c757692ea172aafc' THEN COUNT("ammAddress") ELSE 0 END AS wcryptopunks_gt,
                CASE
                  WHEN "ammAddress" = '0x1812dbda7a954e829a6ada968cee0d3f315ddba2' THEN COUNT("ammAddress") ELSE 0 END AS bayc_gt,
                CASE	
                  WHEN "ammAddress" = '0x77eb2f64a0a94b98283060d35645e6e2eade029c' THEN COUNT("ammAddress") ELSE 0 END AS azuki_gt,
                CASE
                  WHEN "ammAddress" = '0xf7749f92627985afde9bc8577a66cadc3e055589' THEN COUNT("ammAddress") ELSE 0 END AS mayc_gt,
                CASE
                  WHEN "ammAddress" = '0x6aad9d74c2a9c0a185fc08adee633ab6a6968375' THEN COUNT("ammAddress") ELSE 0 END AS degods_gt,
                CASE
                  WHEN "ammAddress" = '0x0c237df9af7c2246001c30e632839efb7c58a2f4' THEN COUNT("ammAddress") ELSE 0 END AS thecaptiainz_gt,
                CASE
                  WHEN "ammAddress" = '0x99cdbb85154be3a2eb1876aead11d78cd9c17034' THEN COUNT("ammAddress") ELSE 0 END AS pudgypenguins_gt,
                CASE
                  WHEN "ammAddress" = '0x98347f01b6b023bfbeb4b534cc48d43f2cfb562b' THEN COUNT("ammAddress") ELSE 0 END AS milady_gt 
            FROM "Position" 
    ...
    FROM (SELECT "userAddress",  
          CASE 
            WHEN "ammAddress" = '0xfdee694ab487321a205ff077c757692ea172aafc' THEN SUM("openNotional") ELSE 0 END AS wcryptopunks_pnl,
          CASE
            WHEN "ammAddress" = '0x1812dbda7a954e829a6ada968cee0d3f315ddba2' THEN SUM("openNotional") ELSE 0 END AS bayc_pnl,
          CASE	
            WHEN "ammAddress" = '0x77eb2f64a0a94b98283060d35645e6e2eade029c' THEN SUM("openNotional") ELSE 0 END AS azuki_pnl,
          CASE
            WHEN "ammAddress" = '0xf7749f92627985afde9bc8577a66cadc3e055589' THEN SUM("openNotional") ELSE 0 END AS mayc_pnl,
          CASE
            WHEN "ammAddress" = '0x6aad9d74c2a9c0a185fc08adee633ab6a6968375' THEN SUM("openNotional") ELSE 0 END AS degods_pnl,
          CASE
            WHEN "ammAddress" = '0x0c237df9af7c2246001c30e632839efb7c58a2f4' THEN SUM("openNotional") ELSE 0 END AS thecaptiainz_pnl,
          CASE
            WHEN "ammAddress" = '0x99cdbb85154be3a2eb1876aead11d78cd9c17034' THEN SUM("openNotional") ELSE 0 END AS pudgypenguins_pnl,
          CASE
            WHEN "ammAddress" = '0x98347f01b6b023bfbeb4b534cc48d43f2cfb562b' THEN SUM("openNotional") ELSE 0 END AS milady_pnl
        FROM api."Position"
    ...
    let collectionsPnlResult = await prisma.$queryRaw<any[]>`SELECT 
                                                              ...
                                                              FROM (SELECT "userAddress", 
                                                                      CASE 
                                                                        WHEN "ammAddress" = '0xfdee694ab487321a205ff077c757692ea172aafc' THEN SUM("realizedPnl") ELSE 0 END AS wcryptopunks_pnl,
                                                                      CASE
                                                                        WHEN "ammAddress" = '0x1812dbda7a954e829a6ada968cee0d3f315ddba2' THEN SUM("realizedPnl") ELSE 0 END AS bayc_pnl,
                                                                      CASE	
                                                                        WHEN "ammAddress" = '0x77eb2f64a0a94b98283060d35645e6e2eade029c' THEN SUM("realizedPnl") ELSE 0 END AS azuki_pnl,
                                                                      CASE
                                                                        WHEN "ammAddress" = '0xf7749f92627985afde9bc8577a66cadc3e055589' THEN SUM("realizedPnl") ELSE 0 END AS mayc_pnl,
                                                                      CASE
                                                                        WHEN "ammAddress" = '0x6aad9d74c2a9c0a185fc08adee633ab6a6968375' THEN SUM("realizedPnl") ELSE 0 END AS degods_pnl,
                                                                      CASE
                                                                        WHEN "ammAddress" = '0x0c237df9af7c2246001c30e632839efb7c58a2f4' THEN SUM("realizedPnl") ELSE 0 END AS thecaptiainz_pnl,
                                                                      CASE
                                                                        WHEN "ammAddress" = '0x99cdbb85154be3a2eb1876aead11d78cd9c17034' THEN SUM("realizedPnl") ELSE 0 END AS pudgypenguins_pnl,
                                                                      CASE
                                                                        WHEN "ammAddress" = '0x98347f01b6b023bfbeb4b534cc48d43f2cfb562b' THEN SUM("realizedPnl") ELSE 0 END AS milady_pnl
                                                                    FROM api."Position"
